...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , branch_type{vlSymsp->TOP.branch_type}
    , branch_taken{vlSymsp->TOP.branch_taken}
    , eq_flag{vlSymsp->TOP.eq_flag}
    , lt_signed{vlSymsp->TOP.lt_signed}
    , lt_unsigned{vlSymsp->TOP.lt_unsigned}
    , operand_a{vlSymsp->TOP.operand_a}
    , operand_b{vlSymsp->TOP.operand_b}
    , __PVT__branch_comparator{vlSymsp->TOP.__PVT__branch_comparator}
    , rootp{&(vlSymsp->TOP)}
{
